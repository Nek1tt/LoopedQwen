#!/usr/bin/env python3
"""Train and evaluate one variant of Experiment 004."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run normalized loop-update experiment")
...
def validate_token_budget(config: dict) -> None:
    ...
    print(
        ...
        f"{actual_tokens:,} processed tokens",
        flush=True,
    )
